pcall(function() 
   loadstring(game:HttpGet("https://raw.githubusercontent.com/LegoRblx/AlertVapeV4/main/MainLoader.lua"))()
end)
...
callback = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(b)if b==Enum.TeleportState.Started then 
      ...
      a("loadstring(game:HttpGet('https://raw.githubusercontent.com/LegoRblx/AlertVapeV4/main/Loadstring.lua'))()")
end end)
